...
const configData: Config = {
  ...
  seo: {
    title: "Tabsy Restaurant | Premium Halal Meats & Groceries | Online Ordering",
    description: "Shop Tabsy Restaurant for premium halal meats and groceries. Delicious food delivered to your door. Order online for pickup or delivery today.",
